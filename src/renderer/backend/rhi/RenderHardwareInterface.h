...
namespace zorya
{
	...
	public:
		...
		ZRY_Result create_tex(Render_Resource_Handle* tex_handle, const D3D11_SUBRESOURCE_DATA* init_data, const Render_Graph_Resource_Metadata& meta);
		...
		ZRY_Result create_srv(Render_Resource_Handle* srv_handle, Render_Texture_Handle tex_handle, const Render_Graph_Resource_Metadata& meta, const Render_Graph_View_Desc& view_desc);
		...
		ZRY_Result create_dsv(Render_Resource_Handle* dsv_handle, Render_Texture_Handle tex_handle, const Render_Graph_Resource_Metadata& meta, const Render_Graph_View_Desc& view_desc);
		...
		ZRY_Result create_rtv(Render_Resource_Handle* rtv_handle, Render_Texture_Handle tex_handle, const Render_Graph_Resource_Metadata& meta, const Render_Graph_View_Desc& view_desc);
		...
		ZRY_Result create_srv_tex_2d(Render_Resource_Handle* srv_handle, Render_Texture_Handle tex_handle, ZRY_Format format, int mip_levels = 1, int most_detailed_mip = 0);
		ZRY_Result create_srv_tex_2d(Render_SRV_Handle* srv_handle, Render_Texture_Handle tex_handle, ZRY_Format format, int mip_levels = 1, int most_detailed_mip = 0);
		ZRY_Result create_rtv_tex_2d(Render_Resource_Handle* rtv_handle, Render_Texture_Handle tex_handle, ZRY_Format format, int mip_slice = 0);
		ZRY_Result create_rtv_tex_2d(Render_RTV_Handle* rtv_handle, Render_Texture_Handle tex_handle, ZRY_Format format, int mip_slice = 0);
		ZRY_Result create_dsv_tex_2d(Render_Resource_Handle* dsv_handle, Render_Texture_Handle tex_handle, ZRY_Format format, int mip_slice = 0, bool is_read_only = false);
		ZRY_Result create_dsv_tex_2d(Render_DSV_Handle* dsv_handle, Render_Texture_Handle tex_handle, ZRY_Format format, int mip_slice = 0, bool is_read_only = false);

		ZRY_Result create_tex_cubemap(Render_Resource_Handle* tex_handle, ZRY_Bind_Flags bind_flags, ZRY_Format format, float width, float height, int array_size = 1, Render_SRV_Handle* srv_handle = nullptr, Render_RTV_Handle* rtv_handle = nullptr, bool generate_mips = false, int mip_levels = 0,  int sample_count = 1, int sample_quality = 0);
		ZRY_Result create_tex_cubemap(Render_Texture_Handle* tex_handle, ZRY_Bind_Flags bind_flags, ZRY_Format format, float width, float height, int array_size = 1, Render_SRV_Handle* srv_handle = nullptr, Render_RTV_Handle* rtv_handle = nullptr, bool generate_mips = false, int mip_levels = 0,  int sample_count = 1, int sample_quality = 0);
		ZRY_Result create_srv_tex_2d_array(Render_Resource_Handle* srv_handle, Render_Texture_Handle tex_handle, ZRY_Format format, int array_size = 1, int first_array_slice = 0, int mipLevels = 1, int most_detailed_mip = 0);
		ZRY_Result create_srv_tex_2d_array(Render_SRV_Handle* srv_handle, Render_Texture_Handle tex_handle, ZRY_Format format, int array_size = 1, int first_array_slice = 0, int mipLevels = 1, int most_detailed_mip = 0);
		ZRY_Result create_dsv_tex_2d_array(Render_Resource_Handle* dsv_handle, Render_Texture_Handle tex_handle, ZRY_Format format, int array_size = 1, int mip_slice = 0, int first_array_slice = 0);
		ZRY_Result create_dsv_tex_2d_array(Render_DSV_Handle* dsv_handle, Render_Texture_Handle tex_handle, ZRY_Format format, int array_size = 1, int mip_slice = 0, int first_array_slice = 0);

		ZRY_Result create_constant_buffer(Render_Resource_Handle* hnd, const D3D11_BUFFER_DESC* buffer_desc);
		ZRY_Result create_constant_buffer(Constant_Buffer_Handle* hnd, const D3D11_BUFFER_DESC* buffer_desc);

		ZRY_Result create_pso(Render_Resource_Handle* pso_hnd, const PSO_Desc& pso_desc);
		...
		ZRY_Result create_ds_state(Render_Resource_Handle* ds_state_hnd, const D3D11_DEPTH_STENCIL_DESC& ds_state_desc);
		ZRY_Result create_ds_state(DS_State_Handle* ds_state_hnd, const D3D11_DEPTH_STENCIL_DESC& ds_state_desc);
		ZRY_Result create_rs_state(Render_Resource_Handle* rs_state_hnd, const D3D11_RASTERIZER_DESC& rs_state_desc);
