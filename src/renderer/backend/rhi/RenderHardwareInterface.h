...
namespace zorya
{
	...
	public:
		...
		Result_Code create_srv(Render_Resource_Handle* srv_handle, Render_Texture_Handle tex_handle, const Shader_Resource_View_Desc& desc);
		Result_Code create_srv(Render_SRV_Handle* srv_handle, Render_Texture_Handle tex_handle, const Shader_Resource_View_Desc& desc);
