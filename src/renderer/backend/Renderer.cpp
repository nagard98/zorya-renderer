...
namespace zorya
{
	...
	HRESULT Renderer::init(bool reset)
	{
		...
		////-----------------------------------------------------------
		RETURN_IF_FAILED2(hr, rhi.create_tex_2d(&hnd_final_rt, nullptr, Resource_Usage::DEFAULT, Resource_Bind_Flags{ D3D11_BIND_RENDER_TARGET | D3D11_BIND_SHADER_RESOURCE }, Texture_Format::R8G8B8A8_TYPELESS, g_resolutionWidth, g_resolutionHeight, 1, nullptr, nullptr, false, 1).value);
	...
	HRESULT Renderer::build_ibl_data(Sky_Light& skylight, Render_SRV_Handle hnd_environment_map)
	{
		...
		RETURN_IF_FAILED2(hr, rhi.create_tex_cubemap(&hnd_skybox_map, Resource_Bind_Flags{ D3D11_BIND_SHADER_RESOURCE | D3D11_BIND_RENDER_TARGET }, Texture_Format::R11G11B10_FLOAT, 512, 512, 6, nullptr, nullptr, false, 1).value);
		...
		RETURN_IF_FAILED2(hr, rhi.create_tex_cubemap(&hnd_prefiltered_env_map, Resource_Bind_Flags{ D3D11_BIND_SHADER_RESOURCE | D3D11_BIND_RENDER_TARGET }, Texture_Format::R11G11B10_FLOAT, 64, 64, 6, nullptr, nullptr, true, 0).value);
		...
		RETURN_IF_FAILED2(hr, rhi.create_tex_2d(&hnd_brdf_lut_map, nullptr, Resource_Usage::DEFAULT, Resource_Bind_Flags{ D3D11_BIND_SHADER_RESOURCE | D3D11_BIND_RENDER_TARGET }, Texture_Format::R11G11B10_FLOAT, 512, 512, 1, nullptr, nullptr, true, 1).value);
